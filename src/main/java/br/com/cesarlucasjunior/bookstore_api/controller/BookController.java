...
import br.com.cesarlucasjunior.bookstore_api.service.S3Service;
...
public class BookController {
    ...
    public ResponseEntity<Book> create(@ModelAttribute BookRequest bookRequest) throws IOException {
